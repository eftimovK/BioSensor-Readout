...
#define  USBD_CFG_MAX_NBR_CFG                             2u    /* Configure maximum number of configurations ...       */
                                                                /*  ... supported.                                      */
...
#define  USBD_CFG_MAX_NBR_IF                             2u    /* Configure maximum number of interfaces ...           */
                                                                /* ... per configuration.                               */

#define  USBD_CFG_MAX_NBR_IF_ALT                         2u    /* Configure maximum number of alternative ...          */
                                                                /* ... interfaces per interface.                        */
#define  USBD_CFG_MAX_NBR_IF_GRP                         2u

#define  USBD_CFG_MAX_NBR_EP_DESC                        6u    /* Configure maximum number of endpoints ...            */
                                                                /* ... (including controls).                            */
...
#define USBD_MSC_CFG_MAX_NBR_CFG                 1u
#define USBD_RAMDISK_CFG_BASE_ADDR               0x20041800
#define USBD_RAMDISK_CFG_BLK_SIZE                512u
#define USBD_RAMDISK_CFG_NBR_BLKS                20u
#define USBD_RAMDISK_CFG_NBR_UNITS               1u
#define USBD_RAMDISK_CFG_RDONLY                  DEF_FALSE
...
#define  USBD_CDC_CFG_MAX_NBR_DEV                        1u     /* Max nbr of class instances.                          */
...
#define USBD_MSC_CFG_MAX_LUN                     0u
#define USBD_MSC_CFG_DATA_LEN                    512u
#define USBD_MSC_CFG_MAX_NBR_DEV                 1u
#define USBD_MSC_CFG_MAX_NBR_CFG                 2u
//#define USBD_RAMDISK_CFG_BASE_ADDR               0x20040000
#define USBD_RAMDISK_CFG_BASE_ADDR               0x0005C000
#define USBD_RAMDISK_CFG_BLK_SIZE                512u
#define USBD_RAMDISK_CFG_NBR_BLKS                32u
#define USBD_RAMDISK_CFG_NBR_UNITS               1u

Installation of PHDC windows driver
===================================

There is one INF file (WinUSB_single.inf) associated with one PID (0x1060) for both the basic and multiple QoS 
host applications.
...
You can also clean out all driver instances based on the WinUSB_single.inf by using 

.\dpinst64.exe -u WinUSB_single.inf
